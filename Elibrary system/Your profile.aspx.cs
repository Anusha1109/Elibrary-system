    ...
    public partial class Your_profile : System.Web.UI.Page
    {
        ...
        void updateuserpersonaldetails()
        {
            ...
            try
            {
                ...
                SqlCommand cmd = new SqlCommand("update member_master_table set full_name=@full_name, dob=@dob, contact_no=@contact_no, email=@email, state=@state, city=@city, pincode=@pincode, full_address=@full_address, password=@password, accoubt_status=@accoubt_status WHERE member_id='" + Session["username"].ToString().Trim() + "'", con);
                ...
                cmd.Parameters.AddWithValue("@accoubt_status", "pending");
